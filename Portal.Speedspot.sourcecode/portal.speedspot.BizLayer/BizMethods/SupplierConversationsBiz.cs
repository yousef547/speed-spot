...
{
    public class SupplierConversationsBiz : BizBaseT<SupplierConversation>
    {
        public SupplierConversationsBiz(ISupplierConversationsRepository repository) : base(repository)
        {
        }
        public async Task<List<SupplierConversation>> GetSupplierMessages(int supplierId, int quotationId, DateTime? date)
        {
