...
namespace portal.speedspot.DALRepositories.Migrations
{
    ...
    [Migration("20220227154154_BookTenderRequests_Update")]
    partial class BookTenderRequests_Update
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.PendingRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("PendingRequest");
                });
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.BidBondRequest", b =>
                {
                    b.HasBaseType("portal.speedspot.Models.Concretes.PendingRequest");
                    ...
                    b.HasIndex("BidBondId")
                        .IsUnique()
                        .HasFilter("[BidBondId] IS NOT NULL");

                    b.HasDiscriminator().HasValue("BidBondRequest");
                });
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.BookTenderRequest", b =>
                {
                    ...
                    b.HasIndex("BookTenderId")
                        .IsUnique()
                        .HasFilter("[BookTenderId] IS NOT NULL");

                    b.HasDiscriminator().HasValue("BookTenderRequest");
                });
