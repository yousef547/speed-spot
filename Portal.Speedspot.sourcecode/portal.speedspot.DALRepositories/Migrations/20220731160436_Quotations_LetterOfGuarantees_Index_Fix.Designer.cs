...
namespace portal.speedspot.DALRepositories.Migrations
{
    ...
    [Migration("20220731160436_Quotations_LetterOfGuarantees_Index_Fix")]
    partial class Quotations_LetterOfGuarantees_Index_Fix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("portal.speedspot.Models.BasesAndAbstracts.JournalEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("JournalEntry");
                });

            modelBuilder.Entity("portal.speedspot.Models.BasesAndAbstracts.LetterOfGuarantee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("LetterOfGuarantee");
                });
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.Quotation", b =>
                {
                    ...
                    b.HasIndex("FinalLGId")
                        .IsUnique()
                        .HasFilter("[FinalLGId] IS NOT NULL");

                    b.HasIndex("OpportunityId");

                    b.HasIndex("PerformanceLGId")
                        .IsUnique()
                        .HasFilter("[PerformanceLGId] IS NOT NULL");
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.CreditEntry", b =>
                {
                    b.HasBaseType("portal.speedspot.Models.BasesAndAbstracts.JournalEntry");

                    b.Property<decimal>("CreditAmount")
                        .HasColumnType("decimal(18,2)");

                    b.HasDiscriminator().HasValue("CreditEntry");
                });

            modelBuilder.Entity("portal.speedspot.Models.Concretes.DebitEntry", b =>
                {
                    b.HasBaseType("portal.speedspot.Models.BasesAndAbstracts.JournalEntry");
                    ...
                    b.HasDiscriminator().HasValue("DebitEntry");
                });

            modelBuilder.Entity("portal.speedspot.Models.Concretes.FinalLG", b =>
                {
                    b.HasBaseType("portal.speedspot.Models.BasesAndAbstracts.LetterOfGuarantee");

                    b.HasDiscriminator().HasValue("FinalLG");
                });
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.PerformanceLG", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("PerformanceLG");
                });
            ...
            modelBuilder.Entity("portal.speedspot.Models.BasesAndAbstracts.JournalEntry", b =>
                {
                    b.HasOne("portal.speedspot.Models.Concretes.FinancialAccount", "FromAccount")
                        .WithMany()
                        .HasForeignKey("FromAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("portal.speedspot.Models.Concretes.FinancialAccount", "ToAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.Quotation", b =>
                {
                    ...
                    b.HasOne("portal.speedspot.Models.Concretes.FinalLG", "FinalLG")
                        .WithOne("Quotation")
                        .HasForeignKey("portal.speedspot.Models.Concretes.Quotation", "FinalLGId");
                    ...
                    b.HasOne("portal.speedspot.Models.Concretes.PerformanceLG", "PerformanceLG")
                        .WithOne("Quotation")
                        .HasForeignKey("portal.speedspot.Models.Concretes.Quotation", "PerformanceLGId");
