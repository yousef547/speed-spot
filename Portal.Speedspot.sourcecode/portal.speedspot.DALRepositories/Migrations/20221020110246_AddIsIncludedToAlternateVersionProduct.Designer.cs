...
namespace portal.speedspot.DALRepositories.Migrations
{
    ...
    [Migration("20221020110246_AddIsIncludedToAlternateVersionProduct")]
    partial class AddIsIncludedToAlternateVersionProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.FinancialAccountTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.NegotiationResult", b =>
                {
                    ...
                    b.Property<int?>("SelectedAlternateId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SelectedAlternateId");
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.PaymentRequest", b =>
                {
                    ...
                    b.Property<int?>("CashAttachmentId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TransferAttachmentId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("CashAttachmentId");
                    ...
                    b.HasIndex("TransferAttachmentId");
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.PaymentTerm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.PerformaInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.TreasuryTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.AlternateVersion", b =>
                {
                    ...
                    b.HasOne("portal.speedspot.Models.Concretes.QuotationOfferVersion", "QuotationOfferVersion")
                        .WithMany("AlternateVersions")
                        .HasForeignKey("QuotationOfferVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.NegotiationResult", b =>
                {
                    ...
                    b.HasOne("portal.speedspot.Models.Concretes.AlternateVersion", "SelectedAlternate")
                        .WithMany()
                        .HasForeignKey("SelectedAlternateId");
                    ...
                    b.Navigation("SelectedAlternate");
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.PaymentRequest", b =>
                {
                    b.HasOne("portal.speedspot.Models.Concretes.Attachment", "CashAttachment")
                        .WithMany()
                        .HasForeignKey("CashAttachmentId");
                    ...
                    b.HasOne("portal.speedspot.Models.Concretes.Attachment", "TransferAttachment")
                        .WithMany()
                        .HasForeignKey("TransferAttachmentId");

                    b.Navigation("CashAttachment");
                    ...
                    b.Navigation("TransferAttachment");
                });
            ...
            modelBuilder.Entity("portal.speedspot.Models.Concretes.QuotationOfferVersion", b =>
                {
                    b.Navigation("AlternateVersions");
