...
{
    [ViewComponent(Name = "RejectedFS")]
    public class RejectedFSQuotationsViewComponent : ViewComponent
    {
        ...
        public RejectedFSQuotationsViewComponent(
            IMapper mapper,
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            {
                quotationVMs = _mapper.Map<List<QuotationViewModel>>(await _quotationsBiz.GetFinancialSessionRejectedAsync());
            }
            else
            {
                quotationVMs = _mapper.Map<List<QuotationViewModel>>(await _quotationsBiz.GetFinancialSessionRejectedAsync(user.Id, user.DepartmentId,
